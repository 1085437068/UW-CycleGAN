...
def parse_opt(known=False):
    ...
    parser.add_argument('--clean-dir', default='test_img/Test/gt', help='dir of dataset')
    parser.add_argument('--depth-dir', default='test_img/Test/gt', help='dir of dataset')
    parser.add_argument('--underwater-dir', default='test_img/Test/test', help='dir of dataset')
    parser.add_argument('--underwater-dir-refer', default='test_img/Test/gt', help='dir of dataset')
